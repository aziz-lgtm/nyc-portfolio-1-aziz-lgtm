...
export default function Tech() {
    ...
    <section className="flex flex-col items-center p-[40px_20px] gap-[24px] w-[393px] h-[602.33px] bg-[linear-gradient(180deg,rgba(158,56,94,0)_0%,rgba(158,56,94,0.1)_99.95%)] flex-none order-2 grow-0 left-1/2 -translate-x-1/2 relative bg-pink-200 ">
        ...
        <Carousel className="flex flex-col justify-center  p-0 gap-[32px] w-[361px] h-[358.33px] flex-none order-1 grow-0 overflow bg-amber-200">
            {/* box html and css */}
            <CarouselContent className="flex flex-row items-start  ml-0 p-0 gap-[16px] w-[361px] h-[281px] flex-none order-0 grow-0">
