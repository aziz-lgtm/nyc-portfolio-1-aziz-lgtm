  ...
  return (
    ...
    {/* box 2 : box stat 1st, box stat 2nd, and box button*/}
      <div className="flex flex-col items-start gap-5 w-90.25 h-56.5 flex-none order-1 self-stretch grow-0">
        ...
        <div className="box-border flex flex-row items-center py-1 px-4 gap-1.5 absolute w-36.5 h-8 left-[calc(50%-73px+0.5px)] top-138.75 bg-primary-400 border border-primary-300 rounded-full">
          <span className="w-2 h-2 bg-[#E26190] rounded-full flex-none order-0 grow-0"></span>
          <p className="w-25 h-6 font-['Montserrat'] font-semibold text-[12px] leading-6 tracking-[-0.03em] text-white flex-none order-1 grow-0">Available for Hire</p>
        </div>
        <h1 className="absolute w-89.25 h-31.5 left-1/2 -translate-x-1/2 top-163 font-['Anton'] font-normal text-[102px] leading-31.25 text-center tracking-[-0.02em] text-secondary-100 -z-10">
        FRONTEND
        </h1>
        <h1 className="absolute w-89.25 h-28.25 left-1/2 -translate-x-1/2 top-[757.94px] font-['Anton'] font-normal text-[92px] leading-28.25 text-center tracking-[-0.02em] text-secondary-100 -z-10">
          DEVELOPER
        </h1>
